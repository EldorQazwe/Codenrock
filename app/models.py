...
class PointsAdded(db.Model):
    ...
    activity_type_id = db.Column(db.Integer, db.ForeignKey(
        'activity_type.id'), nullable=False)
    activity_type = db.relationship(
        'ActivityType', backref='points_added', lazy=True)
...
class ActivityType(db.Model):
    ...
    activities = db.relationship(
        'Activity', backref='activity_type', lazy=True)
